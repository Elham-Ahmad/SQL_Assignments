...
-- Q1)Display first name and last name after converting the first letter of each name to upper case and
...
-- Q3)Display the length of first name for employees where last name contain character ‘b’ after 3rd
-- position.

-- SELECT LEN(FIRST_NAME) FROM EMPLOYEES  WHERE LAST_NAME LIKE '%___B%';


-- Q4)Display first name in upper case and email address in lower case for employees where the first
