...
-- ('3200', 'Mariano Escobedo 9991', '11932', 'Mexico City', '"Distrito Federal', 'NL');
...
-- Q2)Write a query to get all employee details from the employee table order by first name, descending.

-- select * from employees ORDER BY FIRST_NAME DESC;


-- Q3)Write a query to get the employee ID, names (first_name, last_name), salary in ascending order of
-- salary.

-- select EMPLOYEE_ID,FIRST_NAME,LAST_NAME, SALARY from employees ORDER BY SALARY ASC;


-- Q4)Display first name and join date of the employees who is either IT Programmer or Sales Man.
...
-- Q9)Display details of the employees where commission percentage is null and salary in the range 5000
...
-- select FIRST_NAME,EMAIL from employees as emp where emp.DEPARTMENT_ID = 90;
...
-- select FIRST_NAME,LAST_NAME from employees where JOB_ID IN ('IT_PROG','FI_ACCOUNT');
